<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customerbookings.aspx.cs" Inherits="Hotel_Booking_App.customerbookings" %>
...
<body>
    <form id="form1" runat="server"> 
       ...
       <div class="topnav"> <!--χρήση class του εξωτερικού stylesheet που βρίκεται στον φάκελο css, μενού πλοήγησης στο πάνω μέρος σελίδας-->
           ...
           <asp:HyperLink ID="HyperLink2" runat="server" Text="Search Rooms" NavigateUrl="~/search.aspx"></asp:HyperLink>&nbsp&nbsp&nbsp
