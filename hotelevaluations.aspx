<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hotelevaluations.aspx.cs" Inherits="Hotel_Booking_App.WebForm15" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="topnav"> <!--χρήση class του εξωτερικού stylesheet που βρίκεται στον φάκελο css, μενού πλοήγησης στο πάνω μέρος σελίδας-->
           ...
           <asp:HyperLink ID="HyperLink4" runat="server" Text="Bookings" NavigateUrl="~/hotelbookings.aspx"></asp:HyperLink>
       </div>
